...
+ Step 1: Set up data structure and import sample data {#set-up-data-structure-and-ingest-data}
  + [Set up data structure and import sample data using Postman](https://experienceleague.adobe.com/docs/platform-learn/tutorials/import-sample-data.html)
  + [Set up data structure (manually)](/help/tutorial-configure-a-training-sandbox/manual-data-set-up.md)
  + [Import sample data (manually)](/help/tutorial-configure-a-training-sandbox/manual-data-ingestion.md)
