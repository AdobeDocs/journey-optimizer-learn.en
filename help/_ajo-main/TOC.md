...
+ Journeys {#journeys}
  ...
  + [Master multi-attribute filtering](/help/journeys/mastering-multi-attribute-filtering.md)
...
+ [Loyalty](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/loyalty/overview){target="_blank"} 
...
+ Channels {#channels}
  ...
  + Email channel{#email-channel}
    ...
    + [AI-powered, on-brand content creation - Tutorial](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/create-on-brand-content/overview)
  ...
  + Push channel{#push-channel}
    ...
    + [Web push end-to-end tutorial](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/ajo-web-push/introduction)
...
+ Decision Capabilities{#decision-capabilities}
  + Decisioning {#decisioning}
    ...
    + Use decisioning to personalize messages {#use-decisioning}
      ...
      + [Use decisioning within the web visual editor](/help/decisioning/use-decisioning-within-the-web-visual-editor.md)
...
+ AI Assistants and Agents {#ai-assistant}
  ...
  + [Plan audiences using Adobe Marketing Agent](/help/ai-agents/plan-audiences-using-adobe-marketing-agent.md)
