---
title: Simulate journeys with external audiences
description: Learn how to simulate journeys that use external audiences profiles from a CSV file or federated audience composition including attributes not stored in the profile.
feature: Journeys
role: User
level: Intermediate
