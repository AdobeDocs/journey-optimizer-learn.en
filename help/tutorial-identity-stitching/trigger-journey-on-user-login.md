...
## Create E-mail channel confoguration

* Login to _**Journey Optimizer**_
...
* Provide execution details as shown below. The email will be sent to the profile's email address stored in the field
